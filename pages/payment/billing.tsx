...
const PaymentBilling = () => {
	...
	return (
		<Layout withHeader withFooter className="flex flex-row">
			...
			<div className="w-1/2 p-10 flex flex-col">
				<div className="p-10 bg-white">
					<h1 className="text-3xl text-black font-bold pb-12">Billing Address</h1>
					<Form form={form} onFinish={onFinish} layout="vertical" autoComplete="off">
						...
						<Form.Item
							...
							className="pb-6"
						>
							<Input placeholder="Ex: Rasyidin Arsyad Nasution" className="input-billing"/>
							<Divider custom_divider_color="#6B7280" className="bottom-[10px] w-full"/>
						</Form.Item>
						{/* Email Address */}
						<Form.Item
							name="emailaddress"
							...
							className="pb-6"
						>
							<Input placeholder="Ex: rasyid.arsyad@gmail.com" className="input-billing"/>
							<Divider custom_divider_color="#6B7280" className="bottom-[10px] w-full"/>
						</Form.Item>
						{/* Phone Number */}
						<Form.Item
						...
						<Form.Item
							...
							className="pb-6"
						>
							<Input placeholder="Ex: Patriot Street Number 666, Ngaklik, Sleman" className="input-billing"/>
							<Divider custom_divider_color="#6B7280" className="bottom-[10px] w-full"/>
						</Form.Item>
						{/* Country */}
						<Form.Item
							...
							className="pb-6"
						>
							<Input placeholder="Ex: United States of America (USA)" className="input-billing"/>
							<Divider custom_divider_color="#6B7280" className="bottom-[10px] w-full"/>
						</Form.Item>
						{/* State/Province */}
						<Form.Item
						...
						<div className="flex flex-row">
							...
							>
								<Input placeholder="Ex: San Francisco" className="input-billing"/>
								<Divider custom_divider_color="#6B7280" className="bottom-[10px] w-[90%]"/>
							</Form.Item>
							<Form.Item
								name="zipcode"
								label="Zip Code"
				...
				<div className="flex flex-row pt-10">
					<Link href={'/'}>
						<Button ghost className="w-5/12 py-3" htmlType="submit">Continue Shopping</Button>
					</Link>
						<div className="w-2/12"></div>
					<Link href={'/payment/payment'}>
						<Button className="w-5/12 py-3" htmlType="submit">Place My Order</Button>
					</Link>
				</div>
